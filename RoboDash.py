...
# %%
# Averiguar número de nulos
missing_fractions = assets.isnull().mean().sort_index(ascending=False)
missing_fractions.head(10)

# %%
drop_list = sorted(list(missing_fractions[missing_fractions > 0.3].index))
assets = assets.drop(labels=drop_list, axis=1)
assets.shape

# %%
# Los valores nulos se rellenan con el valor anterior
